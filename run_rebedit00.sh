...
USE_GPU=yes
TEST_MODE=no  # If yes, trains a small model with little data to test script
...
#pip3 install --pre "tensorflow==2.3.0rc2"
...
python3 -m script_train_fixed_params_REBEdit00 $EXPT $OUTPUT_FOLDER $USE_GPU $TEST_MODE
